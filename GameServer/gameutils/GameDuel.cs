...
namespace DOL.GS
{
    ...
    public class GameDuel
    {
        ...
        /// Duel Initiator
        /// </summary>
        public GameLiving Starter { get; protected set; }

        /// <summary>
        /// Duel Target
        /// </summary>
        public GameLiving Target { get; protected set; }
        ...
        public virtual void Start()
        {
            ...
            if (Target is GamePlayer playerTarget)
                playerTarget.DuelStart(Starter);
            else if (Target is MimicNPC mimicTarget)
                mimicTarget.DuelStart(Starter);

            if (Starter is GamePlayer)
            {
        ...
        public virtual void Stop()
        {
            ...
            if (Target is GamePlayer playerTarget)
                playerTarget.DuelStop();
            else if (Target is MimicNPC mimicTarget)
                mimicTarget.DuelStop();
            ...
            if (Starter is GamePlayer player)
        ...
        protected virtual void StopNegativeEffects(GameLiving target, GameLiving Caster)
        {
            if (target == null)
                return;
        ...
        /// </summary>
        /// <param name="target"></param>
        protected virtual void StopImmunityEffects(GameLiving target)
        {
            if (target == null)
                return;
